...
Additionally, \hyperref[F:5]{\color{blue}Figure 5} visualizes the effect of excluding all covariates reflected in the shift of the posterior distribution in $M_3$. 
...
\textbf{@Lucas: Falls Du Zeit hast magst, du vielleicht den model weights bzw. Averaging part einbauen - Diskussion kriege ich morgen noch hin}
\section{Discussion}
Points to touch: 
\begin{enumerate}
...
- Table for Model 2 ergänzen in dem Doc war irgendwie nur M1 zweimal  \\
